...
import ActionButton, { DomainActionButton } from "../ActionButton";
...
const BusinessCard: React.FC<BusinessCardProps> = ({ image, title, phrase, content, to }) => {
    ...
    return (
        <div className="card bg-base-100 w-full max-w-102.5 rounded-none shadow-sm">
            ...
            <div className={`bg-primary text-neutral text-center flex flex-col items-center px-8 py-12.5 ${openSans.className}`}>
