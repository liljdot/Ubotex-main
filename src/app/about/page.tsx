            ...
            <main className="p-0 bg-neutral w-full">
                <div className="max-w-450 mx-auto">
                    <section
                        className="
                            flex flex-col 
                            gap-6 md:gap-10 lg:gap-16 xl:gap-23
                            items-center
                            pt-19 md:pt-28 lg:pt-37.5
                            pb-9 lg:pb-18 xl:pb-27">

                        <h1 className="text-primary text-6xl/20 md:text-7xl lg:text-8xl xl:text-[109px] text-center">
                            ABOUT US
                        </h1>
                        ...
                        <div
                            className="
                                flex flex-col
                                text-center
                                gap-15 md:gap-24 lg:gap-32 xl:gap-40
                                px-7.5 md:px-14 lg:px-24 xl:px-34">
